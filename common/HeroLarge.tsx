      ...
      <div className="flex w-3/4 grow-[2] flex-col py-4">
        <div className="mb-6 flex flex-col gap-6">
          ...
          <div className="text-lg text-medium-3">
            {config?.description ??
              `Stake your TSC Gen1 NFTs for $CRIM token yields redeemable rewards in the ${
                config?.displayName ?? shortPubKey(stakePoolId)
              } pool.`}
          </div>
          <a
            target={'_blank'}
            rel="noreferrer"
            href={`https://utility.theshadyclass.xyz/staking`}
          >
            <ButtonSmall onClick={() => {}}>BACK TO MAIN WEBSITE</ButtonSmall>
          </a>
          <StakePoolConfig />
