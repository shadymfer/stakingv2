...
export const SOCIALS = {
  discord: { icon: <FaDiscord />, link: 'https://discord.gg/qMUrjqAjUJ' },
  // github: { icon: <FaGithub />, link: 'https://github.com/cardinal-labs' },
  // medium: { icon: <FaMedium />, link: 'https://cardinal-labs.medium.com/' },
  twitter: { icon: <FaTwitter />, link: 'https://twitter.com/shadies_NFT' },
}
...
export const Footer = ({
  ...
  return (
    <div
      className="mt-32 px-10 pt-2 pb-2 md:px-32"
      style={{
      ...
      {/* <div className="flex w-full flex-wrap items-start justify-between gap-10 py-10">
        ...
        <div className="flex gap-10 self-end text-center md:gap-20">
          ...
          <span className="flex flex-col items-start">
            ...
            <div className='text-md flex flex-row mb-2 mt-4 justify-center font-medium h-[20px]'>
        <img src="/shad.png" />
      </div>
      <div
        className="text-lg flex flex-col items-center justify-center py-4 text-gray-400"
        style={{ borderColor: lighten(0.2, bgColor) }}
      >
        {/* <div className="font-bold flex items-center justify-center gap-2 text-gray-400">
          Powered by Cardinal Labs
        </div> */}
